...
"""
    Tester - Show Statement
    
    Implement a Copy of the tester for programs with show statements
    
    Current Implementation:
        - Generates a candidate
        - Tests Candidate: Creates assumptions and checks for Generated Candidate. If True, then Create World View
            - TODO: If there is a show statement, it will only yield True for those.
        - Create World View.
        
    Problem:
        World View is initialized before Tester
            - No access to control.py variables, therefore cannot communicate through there what atoms have show statements.
                Ex: self.control.show_epistemics, where there is a list of atoms for each show_statement and true candidate found.
                
        World View receives candidate generated through Generator (after been assumed True by tester)
            - Therefore, we cannot modify that Candidate based on show_statements
            
    Solutions
        1. Modify solver.py therefore when there is a candidate and show_statement:
            - Modifies new Cand_pos, Cand_neg. And is returned to WView Solver. 
        2. Modify solver.py execution so it can access control variables generated by Tester.py
        3. (?)
"""
