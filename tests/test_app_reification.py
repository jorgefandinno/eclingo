...
# python -m unittest tests.test_app_reification.TestExamples.test_prog_c19_1
...
class TestExamples(unittest.TestCase):
    ...
    # sol02 -> extra empty world view.
    # sol08 -> do not shows arguments.
    def test_prog_c19_1(self):
        for i in range(1, 11):
            ...
            semantics = "--semantics=c19-1"
            reification = "--reification"
            command = ["python", app_path, semantics, reification, "0"]
    ...
    def test_yale_c19_1(self):
        for i in range(1, 9):
            if i != 6:
                ...
                semantics = "--semantics=c19-1"
                reification = "--reification"
                command = ["python", app_path, semantics, reification, constant, "0"]
                self.assert_world_views(
