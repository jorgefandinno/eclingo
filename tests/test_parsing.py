...
class Test(TestCase):
    ...
    def test_epistemic_atom_with_strong_negation(self):
        self.assert_equal_program(
            parse_program(":- &k{-a}."),
            ":- k_sn_u_a. sn_u_a :- -u_a. {k_sn_u_a} :- sn_u_a.",
        )
        self.assert_equal_program(
            parse_program(":- &k{- -a}."), ":- k_u_a. {k_u_a} :- u_a."
        )
    ...
    def test_epistemic_atom_with_default_negation(self):
        self.assert_equal_program(
            ...
            ":- k_not_u_a. not_u_a :- not u_a. {k_not_u_a} :- not_u_a.",
        )
        self.assert_equal_program(
            parse_program("b :- &k{ not a}."),
            "u_b :- k_not_u_a. not_u_a :- not u_a. {k_not_u_a} :- not_u_a.",
        )
        self.assert_equal_program(
            parse_program(":- &k{ not not a}."),
            ":- k_not2_u_a. not2_u_a :- not not u_a. {k_not2_u_a} :- not2_u_a.",
        )

    def test_epistemic_atom_with_both_negations(self):
        self.assert_equal_program(
            parse_program(":- &k{ not -a}."),
            ":- k_not_sn_u_a. not_sn_u_a :- not sn_u_a. {k_not_sn_u_a} :- not_sn_u_a. sn_u_a :- -u_a.",
        )
        self.assert_equal_program(
            parse_program(":- &k{ not not -a}."),
            ":- k_not2_sn_u_a. not2_sn_u_a :- not not sn_u_a.  {k_not2_sn_u_a} :- not2_sn_u_a. sn_u_a :- -u_a.",
        )

    def test_epistemic_with_variables(self):
        self.assert_equal_program(
            parse_program(":- &k{a(V0)}."), ":- k_u_a(V0). {k_u_a(V0)} :- u_a(V0)."
        )
        self.assert_equal_program(
            parse_program(":- &k{-a(V0)}."),
            ":- k_sn_u_a(V0). sn_u_a(V0) :- -u_a(V0). {k_sn_u_a(V0)} :- sn_u_a(V0).",
        )
        self.assert_equal_program(
            parse_program(":- &k{- -a(V0)}."), ":- k_u_a(V0). {k_u_a(V0)} :- u_a(V0)."
        )
        self.assert_equal_program(
            ...
            ":- k_not_u_a(V0). not_u_a(V0) :- not u_a(V0). {k_not_u_a(V0)} :- not_u_a(V0).",
        )
        self.assert_equal_program(
            parse_program(":- &k{ not not a(V0)}."),
            ":- k_not2_u_a(V0). not2_u_a(V0) :- not not u_a(V0). {k_not2_u_a(V0)} :- not2_u_a(V0).",
        )
        self.assert_equal_program(
            parse_program(":- &k{ not -a(V0)}."),
            ":- k_not_sn_u_a(V0). not_sn_u_a(V0) :- not sn_u_a(V0). {k_not_sn_u_a(V0)} :- not_sn_u_a(V0). sn_u_a(V0) :- -u_a(V0).",
        )
        self.assert_equal_program(
            parse_program(":- &k{ not not -a(V0)}."),
            ":- k_not2_sn_u_a(V0). not2_sn_u_a(V0) :- not not sn_u_a(V0).  {k_not2_sn_u_a(V0)} :- not2_sn_u_a(V0). sn_u_a(V0) :- -u_a(V0).",
        )
    ...
    def test_parameters01(self):
        self.assert_equal_program(
            ...
            "#program parametrized(n). u_a(1..n).",
        )

    def test_parameters02(self):
        self.assert_equal_program(
            parse_program("a(1..n).", ["n"], "base"), "#program base(n). u_a(1..n)."
        )

    def test_heuristic(self):
        self.assert_equal_program(
            parse_program("#heuristic a. [1,sign]", [], "base"),
            "#heuristic u_a. [1,sign]",
        )
