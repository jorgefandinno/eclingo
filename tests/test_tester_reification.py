...
def tester(candidates):
        ...
        # Change the tester, given a list of candidates, test them and give the correct candidates for the world view to show.
